...
(cl:in-package get_rs_image-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name get_rs_image-msg:<Num> is deprecated: use get_rs_image-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader get_rs_image-msg:num-val is deprecated.  Use get_rs_image-msg:num instead.")
  (num m))
